var setTheme = function() {
                ...
                function openSidenav() {
                    ...
                    if (!opened) {
                        ...
                        if (flMenu.hasClass('ish-sn_left')) {
                            ishBody.animate({
                                'right': '-' + sidenavSize + 'px'
                            }, del);
                            flMenu.animate({
                                'left': '0'
                            }, del);
                            jQuery('.ish-back_to_top').animate({
                                'right': 10 - sidenavSize + 'px'
                            }, del);

                            // Unboxed
                            if (jQuery('.ish-sticky-on').length > 0) {
                                header.css({
                                    'right': header.position().left
                                }).animate({
                                    'right': header.position().left - sidenavSize + 'px'
                                }, del, function() {
                                    // Center sticky nav in boxed version on resize
                                    if (jQuery('.ish-boxed').length > 0 && flMenu.is(':visible')) {
                                        jQuery(window).resize(function() {
                                            header.css({
                                                'right': ((jQuery(window).width() - header.width()) / 2) - jQuery('.ish-sidenav').outerWidth()
                                            });
                                        }).resize();
                                    }
                                });
                        ...
                        // Right - default
                            ...
                            if (jQuery('.ish-sticky-on').length > 0) {
                                header.css({
                                    ...
                                    'left': header.position().left - sidenavSize + 'px'
                                }, del, function() {
                                    // Center sticky nav in boxed version on resize
                                    if (jQuery('.ish-boxed').length > 0 && flMenu.is(':visible')) {
                                        jQuery(window).resize(function() {
                                            header.css({
                                                'left': ((jQuery(window).width() - header.width()) / 2) - jQuery('.ish-sidenav').outerWidth()
                                            });
                                        }).resize();
                                    }
                                });
                ...
                function closeSidenav() {
                    if (opened) {
                        ...
                        if (flMenu.hasClass('ish-sn_left')) {
                            ...
                            if (jQuery('.ish-sticky-on').length > 0) {
                                header.animate({
                                    'right': (jQuery(window).width() - header.width()) / 2
                                }, del, function() {
                                    // Center sticky nav in boxed version on resize
                        ...
                        // Right - default
                            ...
                            if (jQuery('.ish-sticky-on').length > 0) {
                                header.animate({
                                    'left': (jQuery(window).width() - header.width()) / 2
                                }, del, function() {
                                    // Center sticky nav in boxed version on resize
                                    if (jQuery('.ish-boxed').length > 0 && flMenu.is(':hidden')) {
                                        jQuery(window).resize(function() {
    ...
    function calculate3dcube(cube) {
        ...
        if (p3dType.hasClass('ish-p-3dcube-top') || p3dType.hasClass('ish-p-3dcube-bottom')) {
            pitem.each(function() {
                var _this = jQuery(this),
                    _height = _this.height() / 2;

                var def1_1 = 'translateZ( -' + _height + 'px )',
                    def1_2 = '50% ' + _height + 'px )';
                _this.css({
                    '-webkit-transform': def1_1,
                    'transform': def1_1,
                    '-webkit-transform-origin:': def1_2,
                    'transform-origin:': def1_2
                });

                var def2 = 'translateZ( ' + _height + 'px )';
                _this.find('.ish-p-img').css({
                    '-webkit-transform': def2,
                    'transform': def2
                });
            });
            ...
            a.hover(function() {}, function() {
                ...
                _this.find('.ish-p-item').css({
                    '-webkit-transform': def1,
                    'transform': def1
                });
        ...
        if (p3dType.hasClass('ish-p-3dcube-top')) {
            pitem.each(function() {
                ...
                _this.find('.ish-p-overlay').css({
                    '-webkit-transform': def3,
                    'transform': def3
                });
            });
        ...
        if (p3dType.hasClass('ish-p-3dcube-left') || p3dType.hasClass('ish-p-3dcube-right')) {
            pitem.each(function() {
                var _this = jQuery(this),
                    _width = _this.width() / 2;

                var def1_1 = 'translateZ( -' + _width + 'px )',
                    def1_2 = '50% ' + _width + 'px )';
                _this.css({
                    '-webkit-transform': def1_1,
                    'transform': def1_1,
    ...
    if (!function_exists('activate_portfolio_ie_no_3d')) {
        ish.activate_portfolio_ie_no_3d = function() {
            ...
            // Check IE
            if (jQuery.browser.msie || typeof ie11 !== 'undefinded') {
        ...
        ish.activate_dynamic_parallax = function() {
            ...
            if (parallaxDyn.length > 0) {
                parallaxDyn.each(function() {
                    ...
                    if (!$dataScroll || $dataScroll == "" || $dataScroll === null) {
                        $dataScroll = '-0.08'
                    }
                    if (!$dataAmount || $dataAmount == "" || $dataAmount === null) {
                        $dataAmount = '50%'
                    }
                    if (!$dur || $dur == "" || $dur === null) {
                        $dur = '500'
            ...
            if (likes_btn.length > 0) {
                ...
                likes_btn.live('click',
                    function() {
                        ...
                        jQuery.post(iyb_globals.admin_ajax, {
                            action: 'ish-like-it',
                            likes_id: id
                        }, function(data) {
        ...
        ish.activate_vunit = function() {
            ...
            (function(h, c) {
                var b = {
                    ...
                    l: function() {
                        return h.setInterval(b.e, b.a.h)
                    },
                    e: function() {
                        var a = b.b.height,
                            d = b.b.width,
                            c = b.d();
                        c.height == a && c.width == d || b.i()
                    },
                    g: function() {
                    ...
                    k: function(a) {
                        for (var d = b.d(), f = d.height / 100, d = d.width / 100, g = "", e = 1; 100 >= e; e++) g += ".vh" + e + "{height:" + Math.round(f * e) + "px;}.vw" + e + "{width:" + Math.round(d * e) + "px;}\n";
                        a.styleSheet ?
                            a.styleSheet.cssText = g : a.appendChild(c.createTextNode(g))
                    },
                    f: function(a) {
                        var d = c.getElementById(b.a.c),
    ...
    if (!function_exists('activate_last_shape_footer')) {
        ish.activate_last_shape_footer = function() {
            ...
            jQuery('[class*="ish-row-svg-bottom-"]:last-child').parent().find('+ .ish-part_footer > .ish-row:first-child').css({
                'padding-top': '50px'
            });
